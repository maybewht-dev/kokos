...
@dp.message_handler(text=['кокос книга рецептов'])
...
<code>кокос</code> Блюдо - рецепт блюда
<code>кокос рецепт</code> Блюда - рецепт блюда""", parse_mode="HTML")

@dp.message_handler(text=['борщ'])
async def process_giveeclairs_command(message: types.Message):
...
@dp.message_handler(text=['капкейки', 'капкейк'])
async def process_giveeclairs_command(message: types.Message):
...
@dp.message_handler(text=['пицца на тонком'])
async def process_giveeclairs_command(message: types.Message):
